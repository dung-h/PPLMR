...
\begin{itemize}
  ...
  \item \textbf{Về nguồn gốc ý tưởng:} Phần mô hình scope/binding được truyền cảm hứng từ các công trình về mô hình ngôn ngữ (ví dụ
        ...
        cụ thể nào. Các test case là tổng quát và không phải là phiên bản sao nguyên vẹn của một bài báo cụ thể.
\end{itemize}
...
\begin{enumerate}
    \item \textbf{Hướng PPL:} Tích hợp với frontend compiler thực để tự động sinh facts
